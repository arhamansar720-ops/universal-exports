        ...
        <div className="footer-top-row">
          ...
          <div className="footer-brand">
            ...
            <div className="footer-socials">
              ...
              <a href="https://x.com" target="_blank" rel="noopener noreferrer" className="footer-soc" aria-label="X / Twitter">
              ...
              <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" className="footer-soc" aria-label="Instagram">
              ...
              <a href="https://linkedin.com" target="_blank" rel="noopener noreferrer" className="footer-soc" aria-label="LinkedIn">
                <svg viewBox="0 0 20 20" fill="currentColor" width="15" height="15">
